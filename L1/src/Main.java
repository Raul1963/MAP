...
public class Main {
    public static void main(String[] args) {
        ...
        Test3 t3=new Test3();
        t3.test_sum(List.of(1,3,0,0,0,0,0,0,0),List.of(8,7,0,0,0,0,0,0,0));
        t3.test_dif(List.of(8,3,0,0,0,0,0,0,0),List.of(5,4,0,0,0,0,0,0,0));
        t3.test_mul(List.of(2,3,6,0,0,0,0,0,0),2);
        t3.test_div(List.of(2,3,6,0,0,0,0,0,0),2);
        Test4 t4=new Test4();
